...
### 8. Ruthlessly Verify
- Ruthleslly verify on `CLAUDE.md` and any of the connected services meta-data about what was pushed and/or spinned up already — whether it is third-party or not.
